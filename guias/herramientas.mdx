...
| **Registrar un referido** | Anota a la persona que el cliente refiere y la plataforma le escribe de su parte. | Se escribe en el manual. | El WhatsApp del referido con código de país. |
...
- **Recordatorio, Programar una acción, Registrar un referido y Avisar a un tercero exigen el dato.**
...
En el manual se ve como **«Registrar Referido Tool»** y su dato es **a quién
refiere el cliente**: el nombre, su WhatsApp con código de país y el contexto
que dé (dónde está, a qué se dedica). El agente la llama **una vez por cada
persona** que el cliente comparta, sea como tarjeta de contacto de WhatsApp o
...
Lo que pasa después no ocurre en ese chat: **la plataforma le escribe al
referido** desde el mismo WhatsApp del agente, «de parte de» quien lo refirió,
en horario de día (entre las 8 y las 20 de tu zona) y arrancando el manual desde
el capítulo 1. En su ficha queda la variable **referido_por** con el nombre y el
teléfono de quien lo refirió, y en la ficha de los dos se ve el referido con su
estado.

Cuatro reglas que el agente ya conoce:

- **No cuenta quien ya te escribió.** Si ese número ya tiene una conversación
  con tu negocio, el agente se lo dice al cliente con amabilidad y no registra
  nada.
- **Gana el primero.** Si dos clientes refieren el mismo número, vale la
  primera; la segunda no cuenta.
- **Nadie se refiere a sí mismo**, y el agente no inventa ni completa un
  número: si llega sin código de país, se lo pide al cliente.
- **El premio no se menciona en el chat.** Si al referido se le marca un
  adelanto desde su ficha, quien lo refirió queda con el premio pendiente; el
  importe se configura por embudo y pagarlo es cosa tuya. El agente no habla de
  premios ni comisiones con nadie.
