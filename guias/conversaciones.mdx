...
<Frame caption="La bandeja de un negocio en marcha: a la izquierda la lista de chats, con la última frase de cada cliente, su capítulo y la hora; a la derecha, la conversación abierta con sus burbujas, los audios y las imágenes que mandó el cliente.">
  <img src="/images/conversaciones/02-bandeja-con-conversaciones.png" alt="Centro de mensajería con la lista de conversaciones a la izquierda y un chat abierto a la derecha" />
</Frame>
...
verdad. Para que puedas probarlo antes de conectar tu WhatsApp, tu cuenta nace
con **US\$ 5** de anticipo — que se descuentan de tu crédito de bienvenida el día
que conectes. Está contado en [Planes y precios](/primeros-pasos/planes-y-precios).
</Note>
