...
- *«Ya subí el catálogo a la Librería: léelo, déjalo enviable para mi agente y
  escribe la sección compartida con lo que dice.»* — es lo mismo que hace el
  tutorial del manual desde el panel, después del primer capítulo.
