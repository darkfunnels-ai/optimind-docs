...
<Steps>
  <Step title="Crea el conjunto de datos, si no tienes ninguno">
    En el menú lateral, **Conjuntos de datos** (en cuentas antiguas, **Orígenes
    de datos**). Si la lista está vacía, pulsa **Conectar datos** y elige
    **Web**: es lo que crea el píxel clásico, y es el que funciona para un
    embudo de WhatsApp.
