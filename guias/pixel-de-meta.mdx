...
DarkFunnels le manda a Meta un aviso (Meta lo llama «evento») por su **API de
...
traba más frecuente, y no la arregla DarkFunnels: te lo da quien administra el
...
<Steps>
  ...
  <Step title="Copia el ID del píxel">
    ...
    <Frame caption="La pestaña Configuración muestra el identificador que va en DarkFunnels.">
...
{/* Cifra de producto: la fuente es MAX_EVENT_AGE_MS en runtime/src/pixels/meta.ts
    (7 días: límite de la propia API de Meta; se cita varias veces en esta página).
