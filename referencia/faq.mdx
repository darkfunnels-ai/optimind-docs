...
**admiración roja** y, al pasar el ratón, **«No enviado: …»** con el motivo en
palabras (tope de mensajes, cliente que pidió no recibir, canal en pausa de
seguridad…). También comprueba que el
...
Sí: todo lo que hace la IA gasta saldo, y el copiloto es IA. **El copiloto** es
la IA de dentro del panel, la del cajón de la derecha —no la confundas con Claude
o ChatGPT conectados por fuera, que en estas páginas son **tu asistente**—.

| Lo que haces con el copiloto | ¿Gasta tu saldo? |
| --- | --- |
| Los mensajes del **alta guiada**: contarle cómo vendes para que te arme el primer agente, capítulo por capítulo | **Sí.** Para eso tu cuenta nace con US\$ 5 de anticipo |
| Los mensajes del ayudante **«Guíame»**, el que te enseña dónde está cada cosa | **Sí**, centavos por pregunta |
| Cualquier otra conversación con el copiloto | **Sí**, y con el saldo agotado se detiene |

Hay un solo presupuesto —tu saldo— y una sola puerta: si alcanza, la IA trabaja;
si no, se detiene y te lo dice. Ya no hay mensajes gratis ni cupos escondidos:
lo que había era un anticipo disimulado y hoy está a la vista, en tu saldo, desde
el primer minuto.

<Note>
**«Tu cuenta no tiene saldo disponible. Recarga créditos para seguir usando el
copiloto.»** Es el aviso que deja el copiloto en el hilo cuando el saldo no
alcanza para un turno más (el corte salta por debajo de US\$ 0,10). Si aún no
conectaste WhatsApp, **conéctalo**: llega el resto de tus créditos de bienvenida.
Si ya lo conectaste, **recarga**. Y si tu prueba venció, ningún saldo lo
desbloquea: hace falta un plan.
→ [Créditos y recarga](/primeros-pasos/creditos-y-recarga)
</Note>
...
<AccordionGroup>
  <Accordion title="Mi saldo dice US\$ 5 y acabo de registrarme">
    Es lo esperado: son los US\$ 5 que tu cuenta adelanta de tus US\$ 10 de
    bienvenida, para que armes y pruebes tu agente antes de conectar nada. El
    resto se acredita **al conectar tu WhatsApp**, y el reloj de la prueba
    arranca en ese mismo momento.
    → [Conecta tu WhatsApp](/primeros-pasos/conecta-whatsapp)
  </Accordion>
  <Accordion title="Me acreditaron US\$ 5 en vez de US\$ 10">
    Los otros cinco ya los tenías desde el registro: son el **anticipo** con el
    que armaste y probaste tu agente, y se descuentan de la bienvenida el día que
    conectas. El total de por vida sigue siendo US\$ 10 (más US\$ 25 con
    referido). Es uno solo por cuenta.
    → [Planes y precios](/primeros-pasos/planes-y-precios)
  </Accordion>
  ...
  <Accordion title="Me llegó un WhatsApp de DarkFunnels, ¿es real?">
...
<AccordionGroup>
  <Accordion title="¿Necesito la API de WhatsApp Business o una cuenta de Meta?">
    No. Tu número se conecta escaneando un QR desde el panel, igual que al
    vincular WhatsApp Web: no pasa por la API de WhatsApp Business (la Cloud
    API de Meta), así que no hay solicitud que aprobar, ni plantillas de
    mensaje, ni cobro por conversación. Sirve WhatsApp normal o WhatsApp
    Business, con el número al que ya te escriben. DarkFunnels no es un
    producto de Meta ni tiene relación con Meta.
    → [Conecta tu WhatsApp](/primeros-pasos/conecta-whatsapp)
  </Accordion>
  ...
  <Accordion title="Mi teléfono dice «No se pudo vincular el dispositivo»">
    Escaneaste y WhatsApp rechazó el vínculo en el último paso; pasa con algunos
    teléfonos en el primer intento. El panel lo detecta en el momento y te lo
    dice mientras vuelve a firmar el mismo código: cierra WhatsApp, vuelve a
    abrir **Dispositivos vinculados** y escanea otra vez el código que está en
    pantalla. Si vuelve a fallar, **Actualizar QR** y de nuevo; si tampoco,
    **Escribir al equipo** desde esa pantalla.
    → [Conecta tu WhatsApp](/primeros-pasos/conecta-whatsapp#problemas-frecuentes)
  </Accordion>
  ...
  <Accordion title="Dice «El código caducó» y no aparece ningún código">
    ...
    escaneó (antes la insignia decía «Acción requerida»; ahora nombra la causa).
    El botón dice **Conectar** y reinicia el ciclo del QR desde cero.
    → [Conecta tu WhatsApp](/primeros-pasos/conecta-whatsapp)
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Me llegó un WhatsApp diciendo que mi embudo tuvo un error">
    Es un aviso real de DarkFunnels a tus números de **Alertas de error**. Nombra
    el embudo y dice en castellano qué pasó —*«no pudo responder a un mensaje del
    cliente, ni al reintentar»*, o *«no pudo entregar una respuesta»* si lo que
    falló fue el envío—, añade **Motivo:** con el detalle y cierra pidiéndote
    revisar la conversación en el panel. Solo sale cuando el reintento automático
    también falló: un bache del que el sistema se recupera solo ya no te avisa.
    Lo accionable es entrar a esa conversación; para no inundarte, llega como
    mucho un aviso cada 5 minutos por embudo y motivo.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Mi asistente no ve mis datos, o los ve vacíos">
    ...
    *«¿con qué cuenta de DarkFunnels estás conectado?»* —tiene una herramienta para
