---
title: "Glosario"
description: "Las palabras propias de DarkFunnels, explicadas en una línea cada una: agente, embudo, manual, capítulo, catálogo, librería, copiloto, créditos, turno, conversión y el puente para asistentes."
---
...
<AccordionGroup>
  ...
  <Accordion title="Herramienta (del agente)">
    Cada cosa que tu agente puede **hacer** además de escribir: registrar la
    venta, pasarle el chat a una persona, guardar un dato, programar un
    seguimiento, buscar un precio. Unas se escriben en el manual con una frase
    exacta (`Ejecuta la herramienta "Recordatorio Tool" con el query "…"`);
    otras el agente las usa solo. No confundir con las herramientas **del
    puente**, más abajo.

    → [Las herramientas del agente](/guias/herramientas)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Herramienta (del puente)">
    ...
    en tu idioma. Son otra lista distinta de las herramientas **del agente**.
