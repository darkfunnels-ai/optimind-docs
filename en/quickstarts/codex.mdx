---
title: "Connect Codex to your WhatsApp AI agent"
sidebarTitle: "Codex"
description: "Connect Codex — OpenAI's app, editor extension or terminal — to your DarkFunnels WhatsApp AI agent: add the Streamable HTTP server, paste the URL and authorize."
keywords:
  - "Codex MCP server"
...
{/* es-source: quickstarts/codex.mdx @ e091b8d */}
...
<Steps>
  ...
  <Step title="Authorize">
    With the **same account you use to sign in to the DarkFunnels dashboard**. Your
...
- **It can't see your data, or sees it empty** → you authorized with a different
  account. Ask "which DarkFunnels account are you connected to?"; if it isn't
