...
DarkFunnels speaks standard MCP, so it works in any client that supports it. It is
always the same URL:
...
100, VS Code 128 — counting **all** your servers together. DarkFunnels ships 39
