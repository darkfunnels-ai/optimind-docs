...
<Frame caption="El menú completo de una cuenta con las cuatro apps que vienen encendidas. Detrás, la pantalla de Órdenes.">
  <img src="/images/apps/01-ordenes.png" alt="Panel de OptiMind con el menú lateral desplegado —Inicio, Calendario, Inventario, Ventas con su submenú, Órdenes y Administración— y la pantalla Órdenes vacía" />
</Frame>
...
<Steps>
  ...
  <Step title="Calendario">
    ...
    <Frame caption="Calendario en vista de semana. Arriba a la izquierda, el selector de agenda con el nombre del agente.">
      <img src="/images/apps/04-calendario.png" alt="Pantalla Calendario de OptiMind en vista de semana, con el selector de agenda, los botones Día, Semana y Mes, y la columna del día de hoy resaltada" />
    </Frame>
  </Step>
  ...
  <Step title="Inventario">
    ...
    **ALMACENES**; en el medio, dos pestañas —**Stock** y **Movimientos**— y el
    ...
    <Frame caption="Inventario. Un producto sin control de stock aparece con la etiqueta «Sin control».">
      <img src="/images/apps/02-inventario.png" alt="Pantalla Inventario de OptiMind con los contadores arriba, las pestañas Stock y Movimientos y un producto listado" />
    </Frame>
  </Step>
  ...
  <Step title="Ventas">
    ...
    **Manual**, **Conversaciones**, **Clientes** y **Configuración**.
    ...
    <Frame caption="Clientes, dentro del bloque AGENTE. El submenú de Ventas viene abierto de fábrica.">
      <img src="/images/apps/03-clientes.png" alt="Pantalla Clientes de OptiMind con las vistas Cola, Embudo y Tabla y la cola de cierre vacía" />
    </Frame>
