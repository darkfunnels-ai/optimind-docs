...
con tus palabras, él pregunta lo que le falte y te propone el guion **capítulo
por capítulo**, para que **tú apruebes cada uno**. Nada se escribe hasta que
apruebas. La conversación gasta saldo, como todo lo que hace la IA: para eso tu
cuenta nace con **US\$ 5** de anticipo.
...
- El chip **Saldo** — tus dólares de crédito. Nace con **US\$ 5** de anticipo, se
  llena al conectar WhatsApp, se pone **ámbar** cuando queda poco y **rojo** cuando
  el agente ya no responde. Al tocarlo vas a **Saldo y facturación**, que es donde
  se recarga.
...
<AccordionGroup>
  ...
  <Accordion title="Tu agente es un vendedor virtual">
    ...
    sobre tu negocio. Tarda unos minutos y gasta centavos de tu anticipo.
  </Accordion>
  <Accordion title="El paso que lo enciende todo">
    Tu agente atiende por tu número de WhatsApp: escaneas un QR, como en WhatsApp
    Web. Al conectar llegan tus créditos de bienvenida —US\$ 10 menos los US\$ 5
    que tu cuenta ya traía de anticipo, más US\$ 25 si vienes referido— y arranca
    tu prueba gratis.
  </Accordion>
  <Accordion title="Tu saldo son dólares que gasta la IA">
    Hoy dice US\$ 5 —el anticipo— y se llena al conectar WhatsApp. Cada respuesta
    de tu agente descuenta centavos; el chip se pone ámbar cuando queda poco y
    tocándolo recargas.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Mi saldo dice US\$ 5 y no he conectado nada">
    Es lo esperado: son los US\$ 5 que tu cuenta adelanta de tus US\$ 10 de
    bienvenida para que armes y pruebes tu agente. El resto se acredita **al
    conectar tu WhatsApp**, y el reloj de los 15 días arranca en ese momento. Si
    ya está por debajo de US\$ 5, es lo que gastó armar el agente.
  </Accordion>
