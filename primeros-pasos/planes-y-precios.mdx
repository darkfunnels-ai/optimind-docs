...
description: "Cuánto cuesta DarkFunnels: la prueba de 15 días sin tarjeta, qué pasa exactamente el día que vence, cuánto es la suscripción y qué parte de ella vuelve a ti como saldo."
---
...
clientes te paguen a ti**, no para pagarle a DarkFunnels.
</Note>
...
con un código de referido. **US\$ 5** de esos diez los tienes desde el registro,
como anticipo para armar y probar tu agente; el resto se acredita **al conectar
tu WhatsApp**.
...
<Warning>
**Al conectar verás acreditados US\$ 5, no US\$ 10.** Los otros cinco ya estaban en
tu saldo desde el registro: DarkFunnels te los adelanta para que armes tu agente
con el copiloto y lo pruebes en el chat de prueba sin haber conectado nada. No son
un regalo: son un **adelanto**, y se descuentan del crédito de bienvenida el día
que conectas. El total de por vida sigue siendo US\$ 10 (más US\$ 25 con referido).
</Warning>
...
DarkFunnels te avisa **por WhatsApp** — a los números que tengas puestos en
