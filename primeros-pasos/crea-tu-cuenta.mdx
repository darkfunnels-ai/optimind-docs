...
<Note>
Tu prueba son **15 días con hasta 5 agentes activos y US\$10 de crédito**. Tu cuenta
nace con **US\$ 5** de esos diez, adelantados para que armes y pruebes tu agente
desde el primer minuto; **el resto llega cuando conectas tu WhatsApp**, y el reloj
de los 15 días arranca en ese mismo momento. Así nadie quema su prueba mientras
todavía está armando el agente. Lo cuenta entero
...
**Ventas**, **Calendario**, **Órdenes** e **Inventario** activos: no hay nada que
elegir.
...
agente, capítulo por capítulo. No es Claude ni ChatGPT, es parte de DarkFunnels.
Todo lo que hace la IA **gasta saldo**, también esta conversación: por eso tu
cuenta nace con **US\$ 5** de anticipo, que da de sobra para armar y probar el
primer agente. (Las guías llaman «tu asistente» a otra cosa: Claude o ChatGPT
conectados por fuera, que es opcional. Están todos en el
[glosario](/referencia/glosario).)
</Note>

Tu saldo dice **US\$ 5** y ya sirve. No es un regalo ni una cuenta a medias: es un
**anticipo** de tus US\$ 10 de bienvenida, para que puedas armar y probar tu agente
antes de conectar WhatsApp. El día que conectes llega el resto, y ese anticipo se
descuenta de ahí.
