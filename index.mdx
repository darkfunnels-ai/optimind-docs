...
description: "Cómo poner a vender tu WhatsApp con DarkFunnels: crear tu agente, conectar tu número por QR sin la API de WhatsApp Business, escribir su guion, cargar el catálogo y medir resultados."
keywords:
  - "agente de ventas IA para WhatsApp"
  - "conectar WhatsApp sin API"
  - "servidor MCP de WhatsApp"
  - "automatizar ventas por WhatsApp"
  - "chatbot de WhatsApp sin API oficial"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Las herramientas del agente" icon="bolt" href="/guias/herramientas">
    Lo que hace además de escribir: registrar la venta, pasar el chat a una
    persona, programar seguimientos, buscar precios. Y cómo se piden.
  </Card>
