---
title: "Documentación de OptiMind"
description: "Cómo poner a vender tu WhatsApp con OptiMind: crear tu agente, conectar tu número, escribir su guion, cargar el catálogo y medir resultados."
---
...
<Frame caption="Así se ve el panel: el menú de la izquierda, tus agentes en el centro y los números del día arriba.">
  <img src="/images/inicio/01-panel-inicio.png" alt="Pantalla de Inicio del panel de OptiMind con el menú lateral y la tarjeta de un agente" />
</Frame>
